                    ...
                    <table>
                        @if ($siswa->dokumens)
                            ...
                            <tr>
                                ...
                                <td>:
                                    <a href="{{ asset('storage/' . $siswa->dokumens->ijazah_sd_file) }}" target="_blank"
                                        class="btn btn-default btn-sm text-aqua" style="margin-left: 10px"><i
                                            class="fa fa-download"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:
                                    <a href="{{ asset('storage/' . $siswa->dokumens->ijazah_smp_file) }}" target="_blank"
                                        class="btn btn-default btn-sm text-aqua" style="margin-left: 10px"><i
                                            class="fa fa-download"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:
                                    <a href="{{ asset('storage/' . $siswa->dokumens->rapor_file) }}" target="_blank"
                                        class="btn btn-default btn-sm text-aqua" style="margin-left: 10px"><i
                                            class="fa fa-download"></i></a>
                                </td>
                            </tr>
