                    ...
                    <table>
                        @if ($siswa->dokumens)
                            <tr>
                                ...
                                <td>:
                                    <a href="{{ asset($siswa->dokumens->kk_file) }}" target="_blank"
                            ...
                            <tr>
                                ...
                                <td>:
                                    <a href="{{ asset($siswa->dokumens->akta_file) }}" target="_blank"
                                        class="btn btn-default btn-sm text-aqua" style="margin-left: 10px"><i
                                            class="fa fa-download"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:
                                    <a href="{{ asset($siswa->dokumens->ijazah_sd_file) }}" target="_blank"
                                        class="btn btn-default btn-sm text-aqua" style="margin-left: 10px"><i
                                            class="fa fa-download"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:
                                    <a href="{{ asset($siswa->dokumens->ijazah_smp_file) }}" target="_blank"
                                        class="btn btn-default btn-sm text-aqua" style="margin-left: 10px"><i
                                            class="fa fa-download"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:
                                    <a href="{{ asset($siswa->dokumens->rapor_file) }}" target="_blank"
                                        class="btn btn-default btn-sm text-aqua" style="margin-left: 10px"><i
                                            class="fa fa-download"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:
                                    <a href="{{ asset($siswa->dokumens->foto_file) }}" target="_blank"
                                        class="btn btn-default btn-sm text-aqua" style="margin-left: 10px"><i
                                            class="fa fa-download"></i></a>
                                </td>
                            </tr>
