        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="{{ route('users.store') }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control @error('role') is-invalid @enderror" id="role" name="role">
                                ...
                                <option value="admin" @if (old('role') == 'admin') selected="selected" @endif>Admin
                                </option>
                                <option value="petugas_baznas" @if (old('role') == 'petugas_baznas') selected="selected" @endif>
                                    Petugas Baznas</option>
                                <option value="petugas_upz" @if (old('role') == 'petugas_upz') selected="selected" @endif>
                                    Petugas UPZ</option>
                            </select>
                            @error('role')
                                <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        <label for="image" class="col-sm-3 control-label">Foto Profil</label>
