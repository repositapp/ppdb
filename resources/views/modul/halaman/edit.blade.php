...
@section('content')
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="{{ route('halaman.update', $halaman->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="tinymce @error('konten') is-invalid @enderror" rows="10" name="konten" id="konten">{{ old('konten', $halaman->konten) }}</textarea>
                            @error('konten')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control @error('status') is-invalid @enderror" id="status"
                                ...
                                <option value="0" @if (old('status', $halaman->status) == 0) selected="selected" @endif> Private
                                </option>
                                <option value="1" @if (old('status', $halaman->status) == 1) selected="selected" @endif> Publish
                                </option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">
